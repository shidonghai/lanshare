...
public class HistoryListAdapter extends BaseAdapter {
    ...
    public HistoryListAdapter(Context context, List<HistoryInfo> historyList, boolean autoRequery) {
    ...
    private View getHeaderView(View convertView) {
        ...
        ((TextView) v.findViewById(R.id.storaget_info)).setText(mContext.getString(
                R.string.dm_memory_state, totalSpace, freeSpace));
        ...
        flowBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mContext.startActivity(new Intent(mContext, TrafficInformationFragment.class));
            }
        });
        return v;
    }
